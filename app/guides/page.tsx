...
export const metadata = createPublicMetadata({
  ...
  description:
    "Πρακτικοί οδηγοί για την επιλογή τροφής σκύλου και τη μερίδα σκύλου και γάτας, με πηγές και σαφή όρια κτηνιατρικής συμβουλής.",
  path: "/guides",
});
    ...
    <main className="min-h-screen bg-[#fbfcfa] text-[#14221b]">
      ...
      <div className="nt-container py-12 sm:py-16">
        ...
        <p className="mt-5 max-w-2xl text-base leading-8 text-[#42534a]">
          Δες πώς να επιλέξεις τροφή για τον σκύλο σου και πώς να ξεκινήσεις
          με τη σωστή μερίδα για σκύλο ή γάτα, χωρίς γενικές υποσχέσεις.
        </p>
