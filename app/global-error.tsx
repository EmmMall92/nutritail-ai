...
function reportGlobalError(error: Error & { digest?: string }) {
  fetch("/api/monitoring/client-error", {
    ...
    // Global fallback should stay usable even if monitoring is unavailable.
  });
}
        ...
        <main className="flex min-h-screen items-center justify-center bg-[#f7f7f4] px-6 text-black">
          <section className="w-full max-w-xl rounded-3xl border border-black/10 bg-white p-8 text-center shadow-sm">
            ...
            <h1 className="mt-3 text-3xl font-black">
              Το Nutritail δεν φόρτωσε σωστά.
            </h1>
            <p className="mt-4 leading-7 text-gray-700">
              Καταγράψαμε το σφάλμα για έλεγχο. Μπορείς να δοκιμάσεις ξανά ή
              να επιστρέψεις στην αρχική σελίδα.
            </p>
