...
- Ανάγκη ηρεμίας: ${nutrition.rer} kcal/ημέρα
  Αυτό είναι περίπου το βασικό ποσό ενέργειας που χρειάζεται το σώμα σε πλήρη ηρεμία.

- Αρχικός ημερήσιος στόχος: ${nutrition.der} kcal/ημέρα
  Αυτό είναι το πρακτικό σημείο εκκίνησης πριν την τελική προσαρμογή για απώλεια ή αύξηση βάρους. Λαμβάνει υπόψη βάρος, ηλικία, δραστηριότητα και στείρωση.
