...
| Food recommendation accuracy | Strong beta | Dog 001-200, dog 201-600, and cat 001-500 QA banks pass with deterministic Food V2 ranking and OpenAI guarded from inventing foods. Fresh July 4 proof: dog 001-200 passed 200/200 live with OpenAI extraction enabled; cat 001-500 passed 500/500 live against the Food V2 recommendation endpoint after the renal wet-only format-gap fix. | Convert every real beta mistake into a ranking/intake guard and keep dog/cat suites fresh after recommendation changes. |
