...
| Food recommendation accuracy | Strong beta | Dog 201-600 and cat 001-500 QA banks pass with deterministic Food V2 ranking and OpenAI extraction guarded from inventing foods. | Convert every real beta mistake into a ranking/intake guard and keep dog/cat suites fresh after recommendation changes. |
