...
const defaultDocumentPath = "C:/Users/NIOstb/Desktop/photo_foods_nutritail/Sam's Field.οκ.docx";

const paths = {
  template: "data/templates/nutritail-food-v2-template.csv",
  output: "data/imports/sams_field_document_extract_v2.csv",
  review: "data/review/sams_field_document_extract_review.csv",
  report: "reports/sams_field_document_extract.md",
};
...
function titleCase(value) {
  return cleanText(value)
    ...
    .replace(/Sam'S/g, "Sam's");
}

function isHeading(value) {
  const text = cleanText(value);
  return /^Sam'?s Field\s+/iu.test(text) && text.length < 110;
}

function canonicalFormulaName(heading) {
  return titleCase(
    cleanText(heading)
      .replace(/^Sam'?s\s+/iu, "Sam's ")
      .replace(/\b\d+(?:[,.]\d+)?\s*(?:kg|gr|g)\b/giu, "")
      .replace(/\d+(?:[,.]\d+)?\s*(?:kg|gr|g)\b/giu, "")
      .replace(/\s+/g, " "),
  );
}
...
function sectionValue(paragraph, labelPattern, stopPattern) {
  ...
  const value = paragraph.slice(match.index + match[0].length);
...
function extractBlocks(paragraphs) {
  ...
  for (let index = 0; index < paragraphs.length; index += 1) {
    ...
    const ingredientText = readBlockSection(
      ...
      /(?:\u0391\u03bd\u03b1\u03bb\u03c5\u03c4\u03b9\u03ba\u03ac|\u0391\u03bd\u03b1\u03bb\u03c5\u03c4\u03b9\u03ba\u03ac\s+\u03a3\u03c4\u03bf\u03b9\u03c7\u03b5\u03af\u03b1|\u0394\u03b9\u03b1\u03c4\u03c1\u03bf\u03c6\u03b9\u03ba\u03ad\u03c2|Analytical|Additives)\s*:/iu,
    );
    const analysisText = readBlockSection(
      blockParagraphs,
      /(?:\u0391\u03bd\u03b1\u03bb\u03c5\u03c4\u03b9\u03ba\u03ac\s+(?:\u03c3\u03c5\u03c3\u03c4\u03b1\u03c4\u03b9\u03ba\u03ac|\u03a3\u03c4\u03bf\u03b9\u03c7\u03b5\u03af\u03b1)|Analytical\s+constituents)\s*:/iu,
      /(?:\u0394\u03b9\u03b1\u03c4\u03c1\u03bf\u03c6\u03b9\u03ba\u03ad\u03c2|Additives)\s*:/iu,
    );
    ...
    rawBlocks.push({
      ...
      descriptionText: blockParagraphs
        .filter((paragraph) => !/(?:\u03a3\u03cd\u03bd\u03b8\u03b5\u03c3\u03b7|\u0391\u03bd\u03b1\u03bb\u03c5\u03c4\u03b9\u03ba\u03ac|\u0394\u03b9\u03b1\u03c4\u03c1\u03bf\u03c6\u03b9\u03ba\u03ad\u03c2)\s*:/iu.test(paragraph))
        .map(cleanText)
        .join(" "),
      ingredientText,
      analysisText,
      additivesText: blockParagraphs
        .filter((paragraph) =>
          /(?:\u0394\u03b9\u03b1\u03c4\u03c1\u03bf\u03c6\u03b9\u03ba\u03ad\u03c2|Vitamin|\u0392\u03b9\u03c4\u03b1\u03bc\u03af\u03bd\u03b7)/iu.test(paragraph),
        )
        .map(cleanText)
        .join(" "),
    });
  ...
  for (const block of rawBlocks) {
    const key = slugify(
      block.formulaName
        .replace(/\bmedium\b/iu, "")
        .replace(/\badult\s+salmon\s*&\s*potato\b/iu, "salmon potato adult"),
    );
    if (byKey.has(key)) {
...
function inferLifeStage(formulaName) {
  ...
  if (value.includes("puppy") || value.includes("junior")) return "puppy";
...
function inferDogSize(formulaName, descriptionText) {
  ...
  if (name.includes("small") || name.includes("mini")) return "small";
  if (name.includes("large")) return "large";
  if (name.includes("medium")) return "medium";
  if (description.includes("\u03cc\u03bb\u03c9\u03bd \u03c4\u03c9\u03bd \u03bc\u03b5\u03b3\u03b5\u03b8\u03ce\u03bd") || description.includes("\u03cc\u03bb\u03c9\u03bd \u03c4\u03c9\u03bd \u03c6\u03c5\u03bb\u03ce\u03bd")) return "all";
  if (description.includes("\u03bc\u03b5\u03b3\u03b1\u03bb\u03cc\u03c3\u03c9\u03bc")) return "large";
  if (description.includes("\u03bc\u03b5\u03c3\u03b1\u03af\u03bf\u03c5")) return "medium";
  if (description.includes("\u03bc\u03b9\u03ba\u03c1\u03cc\u03c3\u03c9\u03bc")) return "small";
  return "all";
}
...
function tagsFor(formulaName, ingredients) {
  ...
  const tags = ["dog", "dry"];
  if (text.includes("grain free") || text.includes("\u03c7\u03c9\u03c1\u03af\u03c2 \u03c3\u03b9\u03c4\u03b7\u03c1")) tags.push("grain_free");
  if (text.includes("puppy") || text.includes("junior")) tags.push("puppy");
  if (text.includes("senior")) tags.push("senior");
  if (text.includes("light") || text.includes("fat dog")) tags.push("weight_control");
  if (text.includes("salmon") || text.includes("\u03c3\u03bf\u03bb\u03bf\u03bc")) tags.push("salmon", "fish");
  if (text.includes("herring") || text.includes("\u03c1\u03ad\u03b3")) tags.push("fish");
  if (text.includes("lamb") || text.includes("\u03b1\u03c1\u03bd")) tags.push("lamb");
  if (text.includes("beef") || text.includes("\u03bc\u03bf\u03c3\u03c7") || text.includes("\u03b2\u03bf\u03b4")) tags.push("beef");
  if (text.includes("duck") || text.includes("\u03c0\u03ac\u03c0\u03b9")) tags.push("duck");
  if (text.includes("chicken") || text.includes("\u03ba\u03bf\u03c4\u03cc\u03c0")) tags.push("chicken");
  if (text.includes("potato") || text.includes("\u03c0\u03b1\u03c4\u03ac\u03c4") || text.includes("\u03b3\u03b5\u03ce\u03bc")) tags.push("potato");
  if (text.includes("corn") || text.includes("\u03ba\u03b1\u03bb\u03b1\u03bc\u03c0\u03cc\u03ba") || text.includes("\u03b1\u03c1\u03b1\u03b2")) tags.push("corn");
  if (text.includes("rice") || text.includes("\u03c1\u03cd\u03b6")) tags.push("rice");
...
function rowFromBlock(block, sourcePath) {
  ...
  return {
    ...
    primary_animal_proteins: ingredients
      .filter((item) => /(\u03ba\u03bf\u03c4\u03cc\u03c0|\u03c3\u03bf\u03bb\u03bf\u03bc|\u03c1\u03ad\u03b3|\u03b1\u03c1\u03bd|\u03bc\u03bf\u03c3\u03c7|\u03b2\u03bf\u03b4|\u03c0\u03ac\u03c0\u03b9|chicken|salmon|herring|lamb|beef|duck)/iu.test(item))
      .join(";"),
    carbohydrate_sources: ingredients
      .filter((item) => /(\u03c0\u03b1\u03c4\u03ac\u03c4|\u03b3\u03b5\u03ce\u03bc|\u03ba\u03b1\u03bb\u03b1\u03bc\u03c0|\u03b1\u03c1\u03b1\u03b2|\u03c1\u03cd\u03b6|potato|corn|rice)/iu.test(item))
      .join(";"),
    fat_sources: ingredients.filter((item) => /(\u03bb\u03af\u03c0\u03bf\u03c2|\u03ad\u03bb\u03b1\u03b9\u03bf|\u03bb\u03ac\u03b4\u03b9|fat|oil)/iu.test(item)).join(";"),
    fiber_sources: ingredients.filter((item) => /(\u03bc\u03ae\u03bb|\u03bd\u03c4\u03bf\u03bc\u03ac\u03c4|apple|tomato)/iu.test(item)).join(";"),
    additives_text: block.additivesText,
    feeding_guide_text: "",
    kcal_per_100g: "",
    kcal_per_kg: "",
    protein_percent: percentAfter(block.analysisText, "(?:\u03c0\u03c1\u03c9\u03c4\u03b5|\u03b1\u03b6\u03c9\u03c4)"),
    fat_percent: percentAfter(block.analysisText, "(?:\u03bb\u03af\u03c0\u03bf\u03c2|\u03bb\u03b9\u03c0\u03b1\u03c1)"),
    fiber_percent: percentAfter(block.analysisText, "(?:\u03af\u03bd\u03b5\u03c2|\u03b9\u03bd\u03b5\u03c2|\u03b9\u03bd\u03ce\u03b4)"),
    ...
    taurine_mgkg: "",
    l_carnitine_mgkg: "",
    glucosamine_mgkg: mgAfter(block.ingredientText, "\u03b3\u03bb\u03c5\u03ba\u03bf\u03c3\u03b1\u03bc\u03af\u03bd\u03b7|glucosamine"),
    chondroitin_mgkg: mgAfter(block.ingredientText, "\u03c7\u03bf\u03bd\u03b4\u03c1\u03bf\u03ca\u03c4\u03af\u03bd\u03b7|chondroitin"),
    vitamin_a_iukg: mgAfter(block.additivesText, "\u0392\u03b9\u03c4\u03b1\u03bc\u03af\u03bd\u03b7\\s*A"),
    vitamin_d3_iukg: mgAfter(block.additivesText, "\u0392\u03b9\u03c4\u03b1\u03bc\u03af\u03bd\u03b7\\s*D3"),
    vitamin_e_mgkg: mgAfter(block.additivesText, "\u0392\u03b9\u03c4\u03b1\u03bc\u03af\u03bd\u03b7\\s*E"),
    iron_mgkg: mgAfter(block.additivesText, "\u03a3\u03af\u03b4\u03b7\u03c1"),
    zinc_mgkg: mgAfter(block.additivesText, "\u03a8\u03b5\u03c5\u03b4\u03ac\u03c1\u03b3\u03c5\u03c1"),
    copper_mgkg: mgAfter(block.additivesText, "\u03a7\u03b1\u03bb\u03ba"),
    manganese_mgkg: mgAfter(block.additivesText, "\u039c\u03b1\u03b3\u03b3\u03ac\u03bd"),
    iodine_mgkg: mgAfter(block.additivesText, "\u0399\u03ce\u03b4\u03b9\u03bf"),
    ...
    source_notes: [
      ...
      "Auto-extracted from Sam's Field document; verify against official source or label before import.",
    ].join("; "),
    formula_key: `sams-field-${slugify(block.formulaName)}-dog-dry-gr-document`,
    ean: "",
  };
}
...
function missingFieldsFor(row) {
  ...
  if (!row.sodium_percent) missing.push("sodium_percent");
...
function reviewRow(row) {
  return {
    ...
    recommended_action:
      "Attach official Sam's Field URL, backfill kcal/ME plus sodium/magnesium if available, then preview in Food V2 before commit.",
    notes: "Document extraction collapses pack sizes to formula-level rows. Keep in review until source provenance is linked.",
  };
}

function renderReport(rows, rawBlockCount, duplicateCount, sourcePath) {
  const coverage = (field) => rows.filter((row) => row[field]).length;
  return `# Sam's Field Document Extract
...
- Duplicate pack blocks skipped: ${duplicateCount}
...
All rows are marked needs_review. The document has useful composition and analytical data, but official URLs, calories, sodium, and magnesium still need review/backfill.
...
async function main() {
  ...
  console.log(`Sam's Field document rows: ${rows.length}`);
  console.log(`Raw complete product blocks: ${rawBlockCount}`);
  console.log(`Duplicate pack blocks skipped: ${duplicateCount}`);
