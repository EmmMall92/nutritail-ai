...
const requiredMarkers = [
  ...
  "passed **23/23** checks with **0 failures**",
  "Bulk chatbot intake validated **1,103** dog/cat user cases",
  ...
  "Cat live recommendation cases **001-100** passed **100/100**",
  "Cat safety smoke passed **10/10** and cat quality smoke passed **10/10**",
  "wet/canned coverage gap",
  "it is **not** a",
  "customer-score unlock by itself",
  "Dog live QA cases **001-200** passed with **200/200** checked and **0 review**",
  "Cat live QA cases **001-500** now also pass with **500/500** checked",
  "renal wet-only case",
  "clear wet/canned Food V2 data",
  "The cat suite checks the live Food V2 recommendation endpoint, not OpenAI fact",
  "OpenAI extraction was **enabled** and checked for each case",
  "deterministic NutriTail ranking remained the source of truth",
  "does **not** raise Customer UX readiness above 88% by itself",
  "live OpenAI/NutriTail proof",
  "## Progress Ladder",
