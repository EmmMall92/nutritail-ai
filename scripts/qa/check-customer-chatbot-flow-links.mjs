...
const checks = [
  ...
  },
  {
    ...
    file: "app/account/chatbot/page.tsx",
    expected: "Παρακολούθησε βάρος, όρεξη, κόπρανα και ενέργεια.",
  },
  {
...
const forbiddenChecks = [
  ...
  {
    label: "Register page does not expose mixed-language reports wording",
    file: "app/register/page.tsx",
    forbidden: "και reports",
  },
  {
    label: "Register page does not expose mixed-language printable reports wording",
    file: "app/register/page.tsx",
  ...
  {
    label: "Printable report page does not expose Greek report missing-data wording",
    file: "app/print/pet-report/page.tsx",
    forbidden: "στοιχεία report",
  },
  {
    label: "Printable report page does not expose Greek nutrition report title wording",
    file: "app/print/pet-report/page.tsx",
    forbidden: "διατροφικό report",
  },
  {
    label: "Printable report page does not expose Greek report footer wording",
    file: "app/print/pet-report/page.tsx",
    forbidden: "Το report δημιουργήθηκε",
  },
  {
    label: "Printable timeline page does not expose mixed-language chatbot report wording",
    file: "app/print/pet-timeline/[id]/page.tsx",
    forbidden: "chatbot report",
  },
  {
    label: "Printable timeline page does not expose mixed-language timeline report wording",
    file: "app/print/pet-timeline/[id]/page.tsx",
    forbidden: "timeline report",
  },
  {
