...
const CASES: DogQaCase[] = [
  ...
  { id: 28, message: "Θέλω τροφή με σολομό για τρίχωμα.", goal: "general", safety: "normal", expected: { species: "dog", preferredProteins: ["salmon"] }, checks: { foodV2Candidates: true, preferredProteinTop: ["salmon", "σολομ"] } },
...
const EXTRA_CASES_101_200: DogQaCase[] = [
  ...
  { id: 162, message: "Έχω σκύλο με δυσπλασία ισχίου.", goal: "senior", safety: "vet_referral", expected: { species: "dog" }, checks: { medicalNoTreatment: true, foodV2Candidates: true } },
  { id: 163, message: "Έχω σκύλο με δυσπλασία αγκώνα.", goal: "senior", safety: "vet_referral", expected: { species: "dog" }, checks: { medicalNoTreatment: true, foodV2Candidates: true } },
  { id: 164, message: "Έχω σκύλο μετά από χειρουργείο χιαστού.", goal: "senior", safety: "vet_referral", expected: { species: "dog" }, checks: { medicalNoTreatment: true, foodV2Candidates: true } },
