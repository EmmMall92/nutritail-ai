...
const REPORT_PATH =
  ...
  "reports/dog_chatbot_100_live_cases.md";
...
const CASES: DogQaCase[] = [
  ...
  { id: 39, message: "Έχω κουτάβι που τρώει πολύ γρήγορα και φουσκώνει.", goal: "growth", safety: "vet_referral", expected: { species: "dog" }, checks: { puppyGrowth: true, medicalNoTreatment: true, foodV2Candidates: true } },
  ...
  { id: 95, message: "Έχω σκύλο rescue, δεν ξέρω ηλικία, είναι περίπου 12kg.", goal: "general", safety: "normal", expected: { species: "dog", weightKg: 12 }, checks: { foodV2Candidates: true } },
