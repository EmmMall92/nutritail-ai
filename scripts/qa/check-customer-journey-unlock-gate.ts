...
const journeys: JourneyProof[] = [
  {
    ...
    requiredEvidence: {
      ...
      account: ["account-next-best-move", "account-plan-snapshot"],
  ...
  },
  {
    ...
    requiredEvidence: {
      ...
      account: ["account-plan-snapshot", "mode=progress"],
  ...
  },
  {
    ...
    requiredEvidence: {
      chatbot: [
        ...
        "selected-food-plan-card",
        "save-analysis-panel",
        "saved-analysis-handoff-panel",
      ],
      account: ["account-plan-snapshot", "account-beta-usage", "Η πλήρης ανάλυση μένει στην αναφορά"],
      report: [
