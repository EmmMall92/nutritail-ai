...
const checks = [
  {
    ...
    expected: [200],
    label: "Homepage",
    requiredText: ["Nutritail AI", "Ενημερωτική επιλογή τροφής"],
  ...
  },
  {
    path: "/beta",
    expected: [307, 308],
    label: "Hidden beta waitlist redirect",
    expectedLocationIncludes: "/register",
    skipBody: true,
  },
  {
    path: "/plans",
  ...
  },
  {
    ...
    expected: [200],
    label: "AI transparency page",
    requiredText: ["Διαφάνεια AI", "Nutritail AI"],
  },
  {
  ...
  },
  {
    ...
    requiredText: [
      ...
      "https://nutritail.ai/ai-transparency",
      "https://nutritail.ai/privacy",
      "https://nutritail.ai/terms",
    ],
    forbiddenText: [
