...
const requiredCardFlowCopy = [
  ...
  "The first picks are the strongest fits.",
  "Simple options are good alternatives when you want something more practical.",
  ...
  "First picks",
  "food option(s) with the strongest fit",
  "Simple options",
  "practical alternatives when they still fit",
  "Your plan is ready",
  "Today's plan",
...
const requiredGreekCardFlowCopy = [
  ...
  "Πάτησε την τροφή που σου αρέσει για να δεις περίπου γραμμάρια/ημέρα",
  "Οι πρώτες προτάσεις είναι οι πιο ταιριαστές.",
  "Πρόταση 1",
  "Πιο απλή επιλογή",
  "Εναλλακτική",
