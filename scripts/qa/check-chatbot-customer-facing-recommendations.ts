...
const requiredCardFlowCopy = [
  ...
  "Portion",
  "Use this as the first 2-4 week starting point.",
  "monitor weight, appetite, and stool",
...
const requiredGreekCardFlowCopy = [
  ...
  "Ποσότητα",
  "Χρησιμοποίησέ το ως αρχικό πλάνο για 2-4 εβδομάδες.",
  "2 γεύματα: περίπου",
  "3 γεύματα: περίπου",
  "πρωτεΐνη",
  "λιπαρά",
