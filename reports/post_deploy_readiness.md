...
Generated: 2026-06-29T05:34:36.319Z
Result: PASS
...
| --- | --- | --- | ---: |
| Public launch live routes | `npm.cmd run qa:public-launch-live-routes` | PASS | 1.7s |
| Food V2 live routes | `npm.cmd run qa:food-v2-live-routes` | PASS | 2.2s |
| Account progress live routes | `npm.cmd run qa:account-progress-live-routes` | PASS | 3.0s |
| Vercel OpenAI production env | `npm.cmd run qa:vercel-openai-env` | PASS | 3.0s |
| Chatbot golden suite fast | `npm.cmd run qa:chatbot-golden-suite:fast` | PASS | 115.5s |
